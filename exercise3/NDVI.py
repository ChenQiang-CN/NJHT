...
class NDVI(BaseProcess):
    ...
    def read_tif_form_hdf(self,path_hdf,path_tem):
        """
    ...
    def Resample_move(self,path_outputtif,path_tiflist_tem):
        """
    ...
    def cloud_identification(self,path_outputtif,path_tif_cutlist):
        """
    ...
    def NDVI_com(self,path_outputtif,path_tif_cutlist):
        """
    ...
    def doInnerPy(self):
        ...
        tif_out = self.pluginParam.getInputInfoByKey('outFolder')

        path_tiflist_tem = self.read_tif_form_hdf(path_hdf,self.tempDir)
        path_tiflist = self.Resample_move(tif_out,path_tiflist_tem)
        path_NDVI = self.NDVI_com(tif_out,path_tiflist)
